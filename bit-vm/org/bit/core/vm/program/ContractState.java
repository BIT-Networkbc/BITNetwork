...
import org.bit.core.vm.program.listener.ProgramListener;
...
import org.bit.core.vm.repository.Value;
...
public class ContractState implements Repository, ProgramListenerAware {
  ...
  public void addTotalBitPowerWeight(long amount) {
    repository.addTotalBitPowerWeight(amount);
  }
  ...
  public void saveTotalBitPowerWeight(long totalBitPowerWeight) {
    repository.saveTotalBitPowerWeight(totalBitPowerWeight);
  }
  ...
  public long getTotalBitPowerWeight() {
    return repository.getTotalBitPowerWeight();
  }

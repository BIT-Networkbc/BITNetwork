...
public class ProgramInvokeImpl implements ProgramInvoke {
  ...
  public ProgramInvokeImpl(byte[] address, byte[] origin, byte[] caller, String balance,
      String callValue, String tokenValue, long tokenId, byte[] msgData,
  ...
  public ProgramInvokeImpl(byte[] address, byte[] origin, byte[] caller, String balance,
       String callValue, String tokenValue, long tokenId, byte[] msgData, byte[] lastHash,
    ...
    this.balance = new DataWord(BigIntegerUtil.newInstance(balance).toByteArray());
    this.callValue = new DataWord(BigIntegerUtil.newInstance(callValue).toByteArray());
    this.tokenValue = new DataWord(BigIntegerUtil.newInstance(tokenValue).toByteArray());

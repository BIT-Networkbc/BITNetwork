...
import static org.bit.common.utils.ByteUtil.EMPTY_BYTE_ARRAY;
import static org.bit.common.utils.ByteUtil.isNullOrZeroArray;
import static org.bit.common.utils.ByteUtil.isSingleZero;
...
public class Hash {
  ...
  static {
    Security.addProvider(BitCastleProvider.getInstance());
    CRYPTO_PROVIDER = Security.getProvider("BC");
    HASH_256_ALGORITHM_NAME = "BIT-KECCAK-256";
    HASH_512_ALGORITHM_NAME = "BIT-KECCAK-512";

package org.bit.common.crypto.sm2;

import static org.bit.common.crypto.Hash.computeAddress;
import static org.bit.common.utils.BIUtil.isLessThan;
import static org.bit.common.utils.ByteUtil.bigIntegerToBytes;
...
import org.bit.common.crypto.ECKey;
import org.bit.common.crypto.SignInterface;
import org.bit.common.crypto.SignatureInterface;
import org.bit.common.crypto.jce.ECKeyFactory;
import org.bit.common.crypto.jce.BitCastleProvider;
...
public class SM2 implements Serializable, SignInterface {
  ...
  private static PrivateKey privateKeyFromBigInteger(BigInteger priv) {
    if (priv == null) {
      ...
      try {
        return ECKeyFactory
            .getInstance(BitCastleProvider.getInstance())

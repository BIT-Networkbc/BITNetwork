...
import org.bit.common.crypto.jce.ECKeyPairGenerator;
import org.bit.common.crypto.jce.BitCastleProvider;
import org.bit.common.utils.BIUtil;
...
public class ECKey implements Serializable, SignInterface {
  ...
  public ECKey(SecureRandom secureRandom) {
    this(BitCastleProvider.getInstance(), secureRandom);
  }
  ...
  public ECKey(byte[] key, boolean isPrivateKey) {
    ...
    this.provider = BitCastleProvider.getInstance();
  }

...
import org.bit.common.cache.CacheManager;
import org.bit.common.cache.CacheType;
import org.bit.common.cache.BitCache;
...
import org.bit.core.db2.common.Flusher;
import org.bit.core.db2.common.WrappedByteArray;
import org.bit.core.store.AccountAssetStore;
...
public class SnapshotRoot extends AbstractSnapshot<byte[], byte[]> {
  ...
  private BitCache<WrappedByteArray, WrappedByteArray> cache;

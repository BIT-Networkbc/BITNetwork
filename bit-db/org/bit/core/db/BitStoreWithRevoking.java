...
import org.bit.core.capsule.ProtoCapsule;
import org.bit.core.db.common.iterator.DBIterator;
import org.bit.core.db2.common.DB;
import org.bit.core.db2.common.IRevokingDB;
import org.bit.core.db2.common.LevelDB;
import org.bit.core.db2.common.RocksDB;
...
import org.bit.core.db2.core.SnapshotRoot;
import org.bit.core.exception.BadItemException;
import org.bit.core.exception.ItemNotFoundException;


@Slf4j(topic = "DB")
public abstract class BitStoreWithRevoking<T extends ProtoCapsule> implements IBitChainBase<T> {
  ...
  protected BitStoreWithRevoking(String dbName) {
  ...
  protected BitStoreWithRevoking(DB<byte[], byte[]> db) {
    this.db = db;

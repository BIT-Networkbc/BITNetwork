package org.bit.core.net.service.handshake;
...
import org.bit.p2p.discover.Node;
...
public class HandshakeService {
  ...
  public void processHelloMessage(PeerConnection peer, HelloMessage msg) {
    ...
    BitNetService.getP2pService().updateNodeId(peer.getChannel(), msg.getFrom().getHexId());
  ...
  private void sendHelloMessage(PeerConnection peer, long time) {
    Node node = new Node(BitNetService.getP2pConfig().getNodeID(),
        BitNetService.getP2pConfig().getIp(),
        BitNetService.getP2pConfig().getIpv6(),
        BitNetService.getP2pConfig().getPort());

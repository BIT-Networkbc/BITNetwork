...
import org.bit.core.config.Parameter.NetConstants;
...
import org.bit.core.net.service.statistics.NodeStatistics;
import org.bit.core.net.service.statistics.PeerStatistics;
...
public class PeerConnection {
  ...
  @Getter
  @Setter
  private BitState bitState = BitState.INIT;
  ...
  public void setChannel(Channel channel) {
    ...
    this.nodeStatistics = BitStatsManager.getNodeStatistics(channel.getInetAddress());
  }
  ...
  public void onConnect() {
    ...
    if (peerHeadBlockNum > headBlockNum) {
      ...
      setBitState(BitState.SYNC_COMPLETED);
    }
  }
  ...
  public static boolean needToLog(Message msg) {
    ...
    if (msg instanceof InventoryMessage && ((InventoryMessage) msg)
            .getInventoryType().equals(Protocol.Inventory.InventoryType.BIT)) {
      return false;
    }

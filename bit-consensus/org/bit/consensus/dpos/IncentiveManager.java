...
import static org.bit.core.config.Parameter.ChainConstant.WITNESS_STANDBY_LENGTH;
...
public class IncentiveManager {
  ...
  public void reward(List<ByteString> witnesses) {
    ...
    for (ByteString witness : witnesses) {
      ...
      accountCapsule.setAllowance(accountCapsule.getAllowance().add(BigInteger.valueOf(pay)).toString());

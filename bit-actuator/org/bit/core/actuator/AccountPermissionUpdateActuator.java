...
import org.bit.protos.Protocol.Key;
import org.bit.protos.Protocol.Permission;
import org.bit.protos.Protocol.Permission.PermissionType;
...
public class AccountPermissionUpdateActuator extends AbstractActuator {
  ...
  public boolean execute(Object object) throws ContractExeException {
    ...
    try {
      ...
      // UPD create multi sign fee to feeManager
//      if (chainBaseManager.getDynamicPropertiesStore().supportBlackHoleOptimization()) {
//        chainBaseManager.getDynamicPropertiesStore().burnBit(fee);
//      } else {

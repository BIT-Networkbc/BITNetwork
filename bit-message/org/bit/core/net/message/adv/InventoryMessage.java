...
import org.bit.protos.Protocol.Inventory;
import org.bit.protos.Protocol.Inventory.InventoryType;


public class InventoryMessage extends BitMessage {
  ...
  public MessageTypes getInvMessageType() {
    return getInventoryType().equals(InventoryType.BLOCK) ? MessageTypes.BLOCK : MessageTypes.BIT;

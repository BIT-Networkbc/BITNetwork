...
import static org.bit.core.services.jsonrpc.JsonRpcApiUtil.convertToBitAddress;
...
import org.bit.protos.Protocol.ResourceReceipt;
...
public class TransactionReceipt {
  ...
  public TransactionReceipt(Protocol.Block block, TransactionInfo txInfo, Wallet wallet) {
    ...
    for (int index = 0; index < txInfo.getLogCount(); index++) {
      ...
      byte[] addressByte = convertToBitAddress(log.getAddress().toByteArray());
